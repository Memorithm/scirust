...
/// A license payload: who it is for, what it unlocks, and when it expires.
///
...
/// binds the exact licensee, module set and validity window — changing any field
...
impl License {
    ...
    pub fn canonical_bytes(&self) -> Vec<u8> {
        let mut o = Vec::new();
        o.extend_from_slice(b"SRL1"); // magic + format version
