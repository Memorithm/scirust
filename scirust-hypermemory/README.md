...
```bash
cargo +nightly-2026-07-02 fmt    -p scirust-hypermemory -- --check
cargo +nightly-2026-07-02 clippy -p scirust-hypermemory --all-targets --all-features --locked -- -D warnings
cargo +nightly-2026-07-02 test   -p scirust-hypermemory --locked
cargo +nightly-2026-07-02 check  -p scirust-hypermemory --all-targets --locked
cargo +nightly-2026-07-02 doc    -p scirust-hypermemory --no-deps
```
