...
cargo run -p scirust-rsi --example evolve_algorithm # evolve a real program (symbolic regression): generator proposes, scirust selects
...
Common flags: `--dim --seed --max-iters --target --patience --time-ms --json --csv <path> --html <path>`.
