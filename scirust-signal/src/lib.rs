...
pub use radar::{
    ...
    propagation_factor, range_bins, range_crlb, range_doppler, range_doppler_map, range_profile,
    range_resolution, rayleigh_cdf as clutter_rayleigh_cdf, rayleigh_pdf as clutter_rayleigh_pdf,
    rayleigh_quantile, resolve_range, ridge as micro_doppler_ridge, rms_bandwidth_lfm,
