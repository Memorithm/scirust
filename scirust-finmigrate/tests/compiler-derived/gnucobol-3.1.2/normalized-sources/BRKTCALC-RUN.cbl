...
*>    85,000 .. 165,000 @ 24%
*>    165,000 ..        @ 32%
    MOVE 0.00        TO WS-LOWER (1)
           MOVE 0.00000 TO WS-RATE (1).
    MOVE 10000.00    TO WS-LOWER (2)
           MOVE 0.10000 TO WS-RATE (2).
    MOVE 40000.00    TO WS-LOWER (3)
           MOVE 0.22000 TO WS-RATE (3).
    MOVE 85000.00    TO WS-LOWER (4)
           MOVE 0.24000 TO WS-RATE (4).
    MOVE 165000.00   TO WS-LOWER (5)
           MOVE 0.32000 TO WS-RATE (5).
