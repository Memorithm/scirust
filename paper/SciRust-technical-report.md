...
- **Inference**: exact (output-preserving) speculative decoding, a tiled
  online-softmax FlashAttention, a DeltaNet delta-rule linear-attention layer, a Mamba selective state-space layer, a RetNet retention layer, and a GLA gated-linear-attention layer.
