...
| F1b | Follow-up 1 — monotone RUL evaluation (realize the lever-1 ceiling) | `claude/scirust-srcc-robust-stats-6ue9xc` (restarted) | [#758](https://github.com/Memorithm/scirust/pull/758) | _(pending)_ | **In review** |
