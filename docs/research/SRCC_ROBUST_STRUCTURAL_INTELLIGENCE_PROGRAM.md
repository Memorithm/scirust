...
| F3 | Follow-up 3 — native heavy-tailed noise (the regime robustness wins) | `claude/scirust-srcc-robust-stats-6ue9xc` (restarted) | _(pending)_ | _(pending)_ | **In review** |
