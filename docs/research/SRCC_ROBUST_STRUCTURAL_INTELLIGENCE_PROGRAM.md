...
| A3 | Axis 3 — real native heavy-tailed contamination (OBD2 robust regression) | `claude/scirust-srcc-robust-stats-6ue9xc` (restarted) | [#766](https://github.com/Memorithm/scirust/pull/766) | _pending_ | Draft |
