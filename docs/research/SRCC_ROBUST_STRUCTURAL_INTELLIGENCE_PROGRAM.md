...
| F2 | Follow-up 2 — stabilized supervised SECOM (feature selection + within-class LDA) | `claude/scirust-srcc-robust-stats-6ue9xc` (restarted) | _(pending)_ | _(pending)_ | **In review** |
