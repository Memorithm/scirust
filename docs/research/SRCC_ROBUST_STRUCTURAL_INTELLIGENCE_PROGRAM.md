...
| 3B | Third program, direction B — robust ∘ nonlinear composition (2×2 factorial on OBD2) | `claude/scirust-srcc-robust-stats-6ue9xc` (restarted) | _pending_ | _pending_ | Draft |
