...
| 3C.1 | Third program, direction C (calibrated uncertainty) — split-conformal prediction module + OBD2 coverage/width study | `claude/scirust-srcc-robust-stats-6ue9xc` (restarted) | _pending_ | _pending_ | Draft |
