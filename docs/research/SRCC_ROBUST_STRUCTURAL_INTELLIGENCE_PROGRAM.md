...
| 3A | Third program, direction A — fast SPD solver (drop format! from cholesky O(n³) loop) + axis-1 stride-20 re-test | `claude/scirust-srcc-robust-stats-6ue9xc` (restarted) | [#769](https://github.com/Memorithm/scirust/pull/769) | _pending_ | Draft |
