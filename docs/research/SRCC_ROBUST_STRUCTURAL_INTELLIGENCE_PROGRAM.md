...
| 3C.2 | Direction C — quantile regression (pinball IRLS) in `scirust-learning` + native-interval vs conformal study | `claude/scirust-srcc-robust-stats-6ue9xc` (restarted) | [#777](https://github.com/Memorithm/scirust/pull/777) | _pending_ | Draft |
