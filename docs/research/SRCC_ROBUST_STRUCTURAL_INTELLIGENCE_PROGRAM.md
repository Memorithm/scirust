...
| A2 | Axis 2 — SECOM past the linear ceiling (drift correction vs degree-2 nonlinearity) | `claude/scirust-srcc-robust-stats-6ue9xc` (restarted) | [#765](https://github.com/Memorithm/scirust/pull/765) | _pending_ | Draft |
