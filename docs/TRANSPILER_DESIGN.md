...
| Tests unitaires (gate CI, sans Python/Octave) | ✅ livré | `scirust-transpiler/src/lib.rs` (92 tests) |
...
**Résultat de l'oracle (reproductible).** 125 cas au total : 43 Python prouvés
contre **NumPy réel**, 82 MATLAB prouvés contre **Octave réel** (chacun 200 essais).
...
tolerance: |Δ| ≤ 1e-7 + 1e-9·|ref|, 200 trials/case
  ...
  ORACLE GREEN — 125/125 cases match their reference runtime within tolerance
```
