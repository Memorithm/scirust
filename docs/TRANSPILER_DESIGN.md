...
| Tests unitaires (gate CI, sans Python/Octave) | ✅ livré | `scirust-transpiler/src/lib.rs` (63 tests) |
...
**Résultat de l'oracle (reproductible).** 62 cas au total : 43 Python prouvés
contre **NumPy réel**, 19 MATLAB prouvés contre **Octave réel** (chacun 200 essais).
