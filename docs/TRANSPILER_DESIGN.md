...
| Tests unitaires (gate CI, sans Python/Octave) | ✅ livré | `scirust-transpiler/src/lib.rs` (91 tests) |
...
**Résultat de l'oracle (reproductible).** 121 cas au total : 43 Python prouvés
contre **NumPy réel**, 78 MATLAB prouvés contre **Octave réel** (chacun 200 essais).
...
tolerance: |Δ| ≤ 1e-7 + 1e-9·|ref|, 200 trials/case
  ...
  ORACLE GREEN — 121/121 cases match their reference runtime within tolerance
```
