...
| Tests unitaires (gate CI, sans Python/Octave) | ✅ livré | `scirust-transpiler/src/lib.rs` (73 tests) |
...
**Résultat de l'oracle (reproductible).** 82 cas au total : 43 Python prouvés
contre **NumPy réel**, 39 MATLAB prouvés contre **Octave réel** (chacun 200 essais).
