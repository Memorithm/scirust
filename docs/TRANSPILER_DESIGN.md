...
| Tests unitaires (gate CI, sans Python/Octave) | ✅ livré | `scirust-transpiler/src/lib.rs` (84 tests) |
...
**Résultat de l'oracle (reproductible).** 104 cas au total : 43 Python prouvés
contre **NumPy réel**, 61 MATLAB prouvés contre **Octave réel** (chacun 200 essais).
