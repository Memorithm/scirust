...
| Tests unitaires (gate CI, sans Python/Octave) | ✅ livré | `scirust-transpiler/src/lib.rs` (80 tests) |
...
**Résultat de l'oracle (reproductible).** 94 cas au total : 43 Python prouvés
contre **NumPy réel**, 51 MATLAB prouvés contre **Octave réel** (chacun 200 essais).
