...
| Tests unitaires (gate CI, sans Python/Octave) | ✅ livré | `scirust-transpiler/src/lib.rs` (77 tests) |
...
**Résultat de l'oracle (reproductible).** 89 cas au total : 43 Python prouvés
contre **NumPy réel**, 46 MATLAB prouvés contre **Octave réel** (chacun 200 essais).
