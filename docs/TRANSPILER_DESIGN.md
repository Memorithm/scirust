...
| Tests unitaires (gate CI, sans Python/Octave) | ✅ livré | `scirust-transpiler/src/lib.rs` (66 tests) |
...
**Résultat de l'oracle (reproductible).** 66 cas au total : 43 Python prouvés
contre **NumPy réel**, 23 MATLAB prouvés contre **Octave réel** (chacun 200 essais).
