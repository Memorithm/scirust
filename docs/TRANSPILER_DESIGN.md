...
| Tests unitaires (gate CI, sans Python/Octave) | ✅ livré | `scirust-transpiler/src/lib.rs` (81 tests) |
...
**Résultat de l'oracle (reproductible).** 96 cas au total : 43 Python prouvés
contre **NumPy réel**, 53 MATLAB prouvés contre **Octave réel** (chacun 200 essais).
