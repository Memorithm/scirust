...
| Tests unitaires (gate CI, sans Python/Octave) | ✅ livré | `scirust-transpiler/src/lib.rs` (79 tests) |
...
**Résultat de l'oracle (reproductible).** 92 cas au total : 43 Python prouvés
contre **NumPy réel**, 49 MATLAB prouvés contre **Octave réel** (chacun 200 essais).
