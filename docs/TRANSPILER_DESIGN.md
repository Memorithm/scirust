...
| Tests unitaires (gate CI, sans Python/Octave) | ✅ livré | `scirust-transpiler/src/lib.rs` (85 tests) |
...
**Résultat de l'oracle (reproductible).** 106 cas au total : 43 Python prouvés
contre **NumPy réel**, 63 MATLAB prouvés contre **Octave réel** (chacun 200 essais).
