...
//
// BatchNorm1d unifié — remplace les 2 versions précédentes :
//   v6   : forward correct mais sans mise à jour des running stats
//   v6.1 : avec running stats updates (notre version finale)
//
// CHOIX DE DESIGN :
...
//
// MIGRATION : aucun changement d'API publique. Les imports
//   `use scirust_core::nn::batch_norm_v6_1::BatchNorm1d` doivent devenir
...
impl Module for BatchNorm1d {
    fn forward<'t>(&mut self, tape: &'t Tape, input: Var<'t>) -> Var<'t> {
        ...
        if self.training {
            // Effet de bord : mise à jour des running stats
...
mod tests {
    ...
    fn running_stats_update_on_training() {
        ...
        // running_mean : 0 → (1-0.1)*0 + 0.1*10 = 1.0
