...
scirust-itd/           2-D field-simulation core: finite-difference curl/gradient (finite & periodic, uniform & non-uniform grids), 2-D trapezoidal integration, five-component structural signature, curvature-weighted rotational intensity (oracle-validated port of the ITD research simulator)
