...
scirust-tolerance/     Inertial tolerancing (Pillet): inertia I=√(δ²+σ²), Cpi/Cpm/Cpk, chain allocation, piloting chart, acceptance sampling, lot mixing, surface/modal (form) tolerancing
